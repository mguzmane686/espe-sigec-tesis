		...
		function () {
			...
			if (!jQuery('#ptTimeSelectCntr').length) {
				jQuery("body").append(
					...
					+	'					<div class="ptTimeSelectLeftPane" style="width: 50%; text-align: center; float: left;" class="">Hora</div>'
					...
					+	'							style="display: block; width: 20px; float: left;">AM</a>'
					+	'						<a class="ptTimeSelectHr ui-state-default" href="javascript: void(0);" '
					+	'							style="display: block; width: 20px; float: left;">PM</a>'
					+	'							<br style="clear: left;" />'
					+	'					</div>'
					+	'				</td>'
