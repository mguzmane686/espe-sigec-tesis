...
@Embeddable
public class HorarioModuloPK implements Serializable {
    ...
    public HorarioModuloPK() {
    }

    public HorarioModuloPK(BigInteger idCursoPeriodo, int idModuloCurso) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HorarioModuloPK)) {
            return false;
        }
        HorarioModuloPK other = (HorarioModuloPK) object;
    ...
    public String toString() {
        return "org.espe.sigec.model.entities.HorarioModuloPK[ idCursoPeriodo=" + idCursoPeriodo + ", idModuloCurso=" + idModuloCurso + " ]";
    }
